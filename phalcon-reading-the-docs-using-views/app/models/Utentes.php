...
class Utentes extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->hasMany('email', 'Consultas_marcadas', 'utentes_email', array('alias' => 'Consultas_marcadas'));
        $this->hasMany('email', 'Consultas_realizadas', 'utentes_email', array('alias' => 'Consultas_realizadas'));
